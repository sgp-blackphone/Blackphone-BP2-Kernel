...
void msm_sensor_set_module_info(struct msm_sensor_ctrl_t *s_ctrl)
{
		...
		if(!strcmp(s_ctrl->sensordata->sensor_name, "s5k3l2"))
			strcat(module_info, "s5k3l2_ofilm");//workround for factory mode camera info.
		else if(!strcmp(s_ctrl->sensordata->sensor_name, "ov5648_q5v22e")){			strcat(module_info, "ov5648_q5v22e");
		//	if(mid == 0x7)
