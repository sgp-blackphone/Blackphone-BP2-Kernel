...
int msm_flash_led_init(struct msm_led_flash_ctrl_t *fctrl)
{
	...
	msleep(5);  //add by liyong2 2015.8.14 To delay a moment between EN gpio setting high and writing I2C registers.
